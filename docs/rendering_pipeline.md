...
| 3. Render | root `scripts/pipeline/stage_03_render.py` | `output/pdf/template_sia_combined.pdf` |
| 4. Copy | root `scripts/pipeline/stage_05_copy.py` | `output/templates/template_sia/` |
